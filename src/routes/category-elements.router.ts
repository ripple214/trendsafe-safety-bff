...
export const createDefaultCategoryElements = (clientId, string, userEmail: string, onSuccess: (data: any) => void, onError?: (error: any) => void) => {
  ...
  let defaultCategoryElements = [
    ...
    {"sort_num": 7,"parent": "","id": "1007","name": "Isolations","partition_key": "$assessments$CATEGORY"},
    ...
    {"sort_num": 107,"parent": "","id": "1120","name": "Plant and Equipment","partition_key": "$controls$CATEGORY"},
    ...
    {"sort_num": 6,"parent": "1004","id": "1006","name": "Health Hazard Compliance","partition_key": "$assessments$ELEMENT"},
    ...
    {"sort_num": 9,"parent": "1007","id": "1009","name": "PPE Conditiona and Suitability","partition_key": "$assessments$ELEMENT"},
    ...
    {"sort_num": 86,"parent": "1093","id": "1099","name": "Depressurize, vent, drain","partition_key": "$controls$ELEMENT"},
    ...
    {"sort_num": 83,"parent": "1093","id": "1096","name": "Hazard barricades","partition_key": "$controls$ELEMENT"},
    ...
    {"sort_num": 127,"parent": "1135","id": "1140","name": "Notify emergency service","partition_key": "$controls$ELEMENT"},
    ...
    {"sort_num": 108,"parent": "1120","id": "1121","name": "Restrain items, tie down, secure","partition_key": "$controls$ELEMENT"},
