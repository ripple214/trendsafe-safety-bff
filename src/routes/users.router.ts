...
router.put('/:userId', function(req, res, next) {
  ...
  var params:any = {
    ...
    ExpressionAttributeValues: {
      ...
      ":administrator": req.body.administrator || 'N', 
      ":leader": req.body.leader || 'false', 
      ":user": req.body.user && !req.body.leader, 
      ":authorizer": req.body.authorizer || 'false', 
      ":recipient": req.body.recipient || 'false',
...
export const createUser = (clientId: string, req: any, onSuccess: (data: any) => void, onError?: (error: any) => void) => {
  ...
  var params:any = {
    ...
    Item: {
      ...
      "administrator": req.body.administrator || 'N', 
      "leader": req.body.leader || 'false', 
      "user": req.body.user && !req.body.leader || 'false', 
      "authorizer": req.body.authorizer || 'false', 
      "recipient": req.body.recipient || 'false',
      "module_access": req.body.module_access || [],
